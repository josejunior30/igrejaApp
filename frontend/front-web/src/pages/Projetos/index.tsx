...
const Projetos = () => {
    ...
    <div className="container-fluid  p-4" id="conteiner-projetos">
                ...
                <div className="row justify-content-center ">
                  <div className="col-6 col-md-2 " id="img-coordenador">
                    <img src={fotoCoordenador} alt="Foto do coordenador" className="img-fluid" />
  ...
  <div className="row  mt-5 row justify-content-center ">
      ...
      {projetosDTO.length > 0 ? (
       ...
       <div key={projeto.id} className="col-7 col-md-2  " id="col-projetos">
        <Link to={`${projeto.id}`}>
          <img src={projeto.foto_lider} alt="Foto do líder" className="img-fluid " />
            
                <h3 className="nome-projeto  ">{projeto.nome}</h3>
                <h3 className="nome-professor">Professor (a): {projeto.lider}</h3>
              </Link>
