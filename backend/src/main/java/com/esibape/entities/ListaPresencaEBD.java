...
public class ListaPresencaEBD implements Serializable{
	...
	public ListaPresencaEBD(Long id, LocalDate data, ChamadaMembro chamadaMembro, ChamadaVisitante chamadaVisitante,
			Membro membro, Visitante visitante, Curso curso) {
		super();
		this.id = id;
		this.data = data;
